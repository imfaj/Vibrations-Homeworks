...
title('Desplazamiento Sist. MRA Forzado respecto a la masa','Fontsize', 10);
...
saveas(gcf,'EfectoMasa_Sist_MRA_Forzado','epsc') % Guarda la imagen en forma eps (Dibujo vectorial
saveas(gcf,'EfectoMasa_Sist_MRA_Forzado','png') % Guarda la imagen en formato png (Mapa de bits)
